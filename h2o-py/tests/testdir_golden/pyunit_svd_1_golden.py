...
def svd_1_golden(ip, port):
    ...
    h2o_v = (zip(*h2o.as_list(h2o.get_frame(fitH2O._model_json['output']['v_key']['name']), use_pandas=False)))
    h2o_v.pop(0)
    ...
    h2o_u = zip(*h2o.as_list(h2o.get_frame(fitH2O._model_json['output']['u_key']['name']), use_pandas=False))
    h2o_u.pop(0)
