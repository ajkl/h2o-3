...
# This test will not run correctly if invoked from debugger.  There is code in
# frame.py that will skip calling Java backend and execution result will be
# incorrect.
...
def quantile_1_golden(ip, port):
    ...
    vec_h2o = h2o.H2OFrame(list(zip(*vec)))
    ...
    vec_cons_h2o = h2o.H2OFrame(zip(*vec_cons))
    ...
    h2o_data = h2o.H2OFrame(zip(*vec_na_h2o))
